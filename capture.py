...
def create_folder(folder_name):
    if not os.path.exists('C:/Users/ANUJ/PycharmProjects/Asl_ML/Gesture/training_set/' + folder_name):
        os.mkdir('C:/Users/ANUJ/PycharmProjects/Asl_ML/Gesture/training_set/' + folder_name)
    if not os.path.exists('C:/Users/ANUJ/PycharmProjects/Asl_ML/Gesture/training_set/' + folder_name):
        os.mkdir('C:/Users/ANUJ/PycharmProjects/Asl_ML/Gesture/training_set/' + folder_name)
    ...
    for loop in listImage:
        while True:
            ...
            if cv2.waitKey(1) == ord('c'):
                ...
                if t_counter <= 350:
                    img_name = "./Gesture/training_set/" + str(ges_name) + "/{}.png".format(training_set_image_name)
                ...
                if t_counter > 350 and t_counter <= 400:
                    img_name = "./Gesture/test_set/" + str(ges_name) + "/{}.png".format(test_set_image_name)
                    save_img = cv2.resize(mask, (image_x, image_y))
                    cv2.imwrite(img_name, save_img)
                    print("{} written!".format(img_name))
                    test_set_image_name += 1
